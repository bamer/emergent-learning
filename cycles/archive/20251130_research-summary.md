...
- `~/.opencode/emergent-learning/memory/heuristics/file-write-safety.md` (H-10, H-11, H-12)
- `~/.opencode/emergent-learning/memory/heuristics/service-coordination.md` (H-13, H-14)
- `~/.opencode/emergent-learning/memory/heuristics/gpu-resource-patterns.md` (H-15)
