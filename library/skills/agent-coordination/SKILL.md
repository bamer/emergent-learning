...
> Multi-agent coordination for Opencode sessions using shared state and structured communication.

## Overview

This skill enables multiple Opencode agents (subagents) to work together on complex tasks by sharing findings, coordinating work, and avoiding duplication of effort.
...
Personality definitions are in `~/.opencode/emergent-learning/agents/*/personality.md`.
...
cp ~/.opencode/skills/agent-coordination/TEMPLATES/* .coordination/
```
...
```
~/.opencode/skills/agent-coordination/
