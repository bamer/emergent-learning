...
ELF is designed for development environments. Opencode runs on your local machine.
...
Create .opencode/AGENTS.md in project repo with team rules.
...
Restrict database to owner-only: chmod 600 ~/.opencode/emergent-learning/memory/index.db
