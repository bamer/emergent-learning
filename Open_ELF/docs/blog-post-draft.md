...
I use Opencode daily. It's powerful. But every session starts from zero.
...
**Emergent Learning Framework** - persistent memory for Opencode sessions.
...
*This post was written with help from Claude. The framework was built with Opencode. I still can't read the code it wrote - but it works.*
