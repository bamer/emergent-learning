...
**Decision:** Use Opencode PreToolUse/PostToolUse hooks

**Rationale:**
- Automatic, no user action required
- Access to task context before/after execution
- Built into Opencode platform
...
## ADR-006: AGENTS.md for Agent Instructions

**Date:** 2024-11-18  
**Status:** Accepted  
**Context:** Need to instruct Claude to query the building

**Decision:** Use AGENTS.md global instructions file

**Rationale:**
- Loaded automatically by Opencode at session start
...
**Decision:** Install to ~/.opencode/emergent-learning/

**Rationale:**
- Standard hidden directory convention
- Grouped with Opencode config (~/.opencode/)
...
- ~/.config/elf/: Doesn't match Opencode convention
...
- Can be included in AGENTS.md or docs
