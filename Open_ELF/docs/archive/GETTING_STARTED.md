...
**Default path:** ELF installs to `~/.opencode/emergent-learning`. Set `ELF_BASE_PATH` to run from a different location.

## Step 0: Prerequisites

### Required: Opencode CLI

ELF extends Opencode. You need it installed first.
...
```bash
python ~/.opencode/emergent-learning/query/query.py --validate
```
...
Just use Opencode normally! The hooks will:
...
# Search by domain
python ~/.opencode/emergent-learning/query/query.py --domain testing

# View statistics
python ~/.opencode/emergent-learning/query/query.py --stats
```
...
```bash
chmod +x install.sh
chmod +x ~/.opencode/emergent-learning/dashboard-app/run-dashboard.sh
```
...
- Try reinstalling dependencies:
  ```bash
  cd ~/.opencode/emergent-learning/dashboard-app/frontend
...
| Task | Command |
|------|---------|
| Query building | `python ~/.opencode/emergent-learning/query/query.py --context` |
| View stats | `python ~/.opencode/emergent-learning/query/query.py --stats` |
| Start dashboard | `cd ~/.opencode/emergent-learning/dashboard-app && ./run-dashboard.sh` |
| Validate install | `python ~/.opencode/emergent-learning/query/query.py --validate` |
