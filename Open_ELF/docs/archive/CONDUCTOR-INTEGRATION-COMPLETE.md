...
**File:** `~/.opencode\emergent-learning\hooks\learning-loop\post_tool_learning.py`
...
**Test file:** `~/.opencode\emergent-learning\test-conductor-direct.py`
...
1. **~/.opencode\emergent-learning\hooks\learning-loop\post_tool_learning.py**
...
1. **~/.opencode\emergent-learning\test-conductor-direct.py**
   - Direct test of conductor API
   - Verifies database records are created correctly

2. **~/.opencode\emergent-learning\test-conductor-integration.py**
