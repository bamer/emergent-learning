...
type MonitorView = 'health' | 'sentinel' | 'chronicle' | 'eventbridge' | 'orchestrator' | 'ceo' | 'ollama' | 'all';
...
export function MonitoringPanel({ apiBaseUrl = '' }: MonitoringPanelProps) {
  ...
  const views = [
    { id: 'health', label: 'System Health', icon: Heart, component: SystemHealthPanel, description: 'Overall system health and real-time metrics' },
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {activeView === 'all' ? (
          layoutMode === 'grid' ? (
            /* Grid Layout - System Health First, then 2x3 */
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
              {/* System Health - FIRST CARD */}
            ...
            /* List Layout - Stacked with hierarchy indicators, System Health First */
            ...
            {activeView === 'health' && (
              <div className="mb-4 p-4 bg-rose-500/10 border border-rose-500/20 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-rose-400">System Health</h3>
                    <p className="text-sm text-slate-400">
                      Real-time system metrics including CPU load, memory usage, swap availability, and LLM server status.
                    </p>
                  </div>
                </div>
              </div>
