...
const SemanticSearchPanel = React.lazy(() => import('./components/SemanticSearchPanel').then(m => ({ default: m.SemanticSearchPanel })))
const MonitoringPanel = React.lazy(() => import('./components/MonitoringPanel').then(m => ({ default: m.MonitoringPanel })))
const AdvancedVisualizations = React.lazy(() => import('./components/visualizations/AdvancedVisualizations').then(m => ({ default: m.AdvancedVisualizations })))
const WorkflowBuilder = React.lazy(() => import('./components/visualizations/WorkflowBuilder').then(m => ({ default: m.WorkflowBuilder })))
const LivePanel = React.lazy(() => import('./components/live/LivePanel').then(m => ({ default: m.LivePanel })))
...
function AppContent() {
  ...
  const commands = useMemo(() => [
    ...
    { id: 'monitoring', label: 'System Monitoring', category: 'Navigation', action: () => setActiveTab('monitoring') },
