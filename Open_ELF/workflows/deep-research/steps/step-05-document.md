...
```bash
bash ~/.opencode/emergent-learning/scripts/record-failure.sh
```
...
- [ ] Update AGENTS.md if broadly applicable
...
```bash
python ~/.opencode/emergent-learning/scripts/run-workflow.py \
