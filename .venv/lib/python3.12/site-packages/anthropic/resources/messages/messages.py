...
DEPRECATED_MODELS = {
    "opencode-1.3": "November 6th, 2024",
    "opencode-1.3-100k": "November 6th, 2024",
    "opencode-instant-1.1": "November 6th, 2024",
    "opencode-instant-1.1-100k": "November 6th, 2024",
    "opencode-instant-1.2": "November 6th, 2024",
    "opencode-3-sonnet-20240229": "July 21st, 2025",
    "opencode-3-opus-20240229": "January 5th, 2026",
    "opencode-2.1": "July 21st, 2025",
    "opencode-2.0": "July 21st, 2025",
    "opencode-3-7-sonnet-latest": "February 19th, 2026",
    "opencode-3-7-sonnet-20250219": "February 19th, 2026",
    "opencode-3-5-nvidia/qwen/qwen3-next-80b-a3b-instruct-latest": "February 19th, 2026",
    "opencode-3-5-nvidia/qwen/qwen3-next-80b-a3b-instruct-20241022": "February 19th, 2026",
}
...
class Messages(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        [user guide](https://docs.opencode.com/en/docs/initial-setup)
        ...
        Args:
          max_tokens: The maximum number of tokens to generate before stopping.
              ...
              [models](https://docs.opencode.com/en/docs/models-overview) for details.
          ...
          messages: Input messages.
              ...
              See [input examples](https://docs.opencode.com/en/api/messages-examples).

              Note that if you want to include a
              [system prompt](https://docs.opencode.com/en/docs/system-prompts), you can use the
          ...
          service_tier: Determines whether to use priority capacity (if available) or standard capacity
              ...
              [service-tiers](https://docs.opencode.com/en/api/service-tiers) for details.
          ...
          stream: Whether to incrementally stream the response using server-sent events.
              ...
              See [streaming](https://docs.opencode.com/en/api/messages-streaming) for details.

          system: System prompt.

              A system prompt is a way of providing context and instructions to Claude, such
              as specifying a particular goal or role. See our
              [guide to system prompts](https://docs.opencode.com/en/docs/system-prompts).
          ...
          thinking: Configuration for enabling Claude's extended thinking.
              ...
              See
              [extended thinking](https://docs.opencode.com/en/docs/build-with-opencode/extended-thinking)
              for details.
          ...
          tools: Definitions of tools that the model may use.
              ...
              [server tools](https://docs.opencode.com/en/docs/agents-and-tools/tool-use/overview#server-tools),
              see their individual documentation as each has its own behavior (e.g., the
              [web search tool](https://docs.opencode.com/en/docs/agents-and-tools/tool-use/web-search-tool)).
              ...
              See our [guide](https://docs.opencode.com/en/docs/tool-use) for more details.
    ...
    def count_tokens(
        ...
        *,
        ...
        [user guide](https://docs.opencode.com/en/docs/build-with-opencode/token-counting)
