...
class Completions(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        [Messages API](https://docs.opencode.com/en/api/messages) going forward.

        Future models and features will not be compatible with Text Completions. See our
        [migration guide](https://docs.opencode.com/en/api/migrating-from-text-completions-to-messages)
        ...
        Args:
          ...
          prompt: The prompt that you want Claude to complete.
              ...
              See [prompt validation](https://docs.opencode.com/en/api/prompt-validation) and
              our guide to [prompt design](https://docs.opencode.com/en/docs/intro-to-prompting)
              for more details.
          ...
          stream: Whether to incrementally stream the response using server-sent events.
              ...
              See [streaming](https://docs.opencode.com/en/api/streaming) for details.
