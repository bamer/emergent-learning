#!/usr/bin/env python3
"""
Get Last Prompts - Retrieve user prompts from previous Opencode sessions.
...
def main():
    parser = argparse.ArgumentParser(
        description="Retrieve user prompts from previous Opencode sessions",
...
Examples:
    ...
    if not project_dir or not project_dir.exists():
        print("Error: Could not find Opencode project directory", file=sys.stderr)
        return 1
