...
- Format: ~/.opencode/emergent-learning/sessions/logs/YYYY-MM-DD_session.jsonl
...
PROCESSED_FILE = Path.home() / ".opencode" / "emergent-learning" / "sessions" / ".processed"
...
class SessionLogger:
    ...
    def __init__(self, logs_dir: Optional[Path] = None):
        ...
        Args:
            logs_dir: Custom logs directory (default: ~/.opencode/emergent-learning/sessions/logs)
        """
