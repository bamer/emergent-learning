...
ls -l ~/.opencode/emergent-learning/logs/$(date +%Y%m%d).log
tail -20 ~/.opencode/emergent-learning/logs/$(date +%Y%m%d).log
...
# 4. Check dashboard
python ~/.opencode/emergent-learning/query/dashboard.py

# 5. View specific metrics
~/.opencode/emergent-learning/scripts/query-metrics.sh recent operation_count 20
~/.opencode/emergent-learning/scripts/query-metrics.sh summary
```
