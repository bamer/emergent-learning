...
**Location:** `~/.opencode/emergent-learning/VERIFICATION_SUMMARY.txt`
...
**Location:** `~/.opencode/emergent-learning/LOCK_CONTENTION_FIX_VERIFICATION.md`
...
**Location:** `~/.opencode/emergent-learning/LOCK_IMPLEMENTATION_DETAILS.md`
...
`~/.opencode/emergent-learning/test-run/`
...
**Primary Script:** `~/.opencode/emergent-learning/scripts/record-failure.sh`
...
1. Lock status can be monitored with: `ls ~/.opencode/emergent-learning/.git/*.lock.dir 2>/dev/null`
2. Performance can be monitored in logs: `~/.opencode/emergent-learning/logs/`
3. Database integrity can be checked: `sqlite3 ~/.opencode/emergent-learning/memory/index.db "PRAGMA integrity_check"`
