...
~/.opencode/emergent-learning/scripts/learning-metrics.sh --json
```
...
# Full analysis
~/.opencode/emergent-learning/scripts/deduplicate-failures.sh --all

# Generate report
~/.opencode/emergent-learning/scripts/deduplicate-failures.sh --report
```

### Get Heuristic Suggestions
```bash
# Quick analysis
~/.opencode/emergent-learning/scripts/suggest-heuristics.sh --stats

# Analyze recent failures
~/.opencode/emergent-learning/scripts/suggest-heuristics.sh --recent 7
...
~/.opencode/emergent-learning/scripts/suggest-heuristics.sh --generate
```
...
```bash
0 9 * * * ~/.opencode/emergent-learning/scripts/self-test.sh >> ~/daily-health.log 2>&1
```

### Weekly Summary Email
```bash
0 9 * * 1 ~/.opencode/emergent-learning/scripts/learning-metrics.sh --detailed | mail -s "Weekly Learning Summary" you@example.com
```

### Continuous Monitoring
```bash
# Run metrics in JSON mode and feed to monitoring system
~/.opencode/emergent-learning/scripts/learning-metrics.sh --json | your-monitoring-tool
```
...
```bash
~/.opencode/emergent-learning/scripts/self-test.sh --help
~/.opencode/emergent-learning/scripts/learning-metrics.sh --help
# etc.
```
