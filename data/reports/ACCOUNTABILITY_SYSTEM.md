...
```bash
~/.opencode/emergent-learning/scripts/record-violation.sh <rule_number> "description"
```
...
```bash
python ~/.opencode/emergent-learning/query/query.py --violations --violation-days 7
```
