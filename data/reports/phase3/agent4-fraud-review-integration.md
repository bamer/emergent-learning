...
**Location:** `~/.opencode/emergent-learning/query/fraud_review.py`
...
**Location:** `~/.opencode/emergent-learning/scripts/review-fraud.sh`
...
1. **Add to PATH** (optional):
   ```bash
   echo 'export PATH="$PATH:$HOME/.opencode/emergent-learning/scripts"' >> ~/.bashrc
   ```

2. **Create alias** (optional):
   ```bash
   alias review-fraud='~/.opencode/emergent-learning/scripts/review-fraud.sh'
   ```
