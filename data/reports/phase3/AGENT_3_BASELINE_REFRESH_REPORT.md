...
```bash
# Refresh all domains
python ~/.opencode/emergent-learning/query/fraud_detector.py refresh-all

# Refresh specific domain
python ~/.opencode/emergent-learning/query/fraud_detector.py update-baseline --domain agent-behavior

# Check results
python ~/.opencode/emergent-learning/query/fraud_detector.py baseline-history --limit 5
```
...
python ~/.opencode/emergent-learning/scripts/baseline-refresh-scheduler.py --setup-task-scheduler

# Configure schedule
python ~/.opencode/emergent-learning/scripts/baseline-refresh-scheduler.py --setup-schedule --interval-days 30
```

**Option 2: Python Daemon**
```bash
# Run daemon (checks hourly)
python ~/.opencode/emergent-learning/scripts/baseline-refresh-scheduler.py --daemon
```
...
python ~/.opencode/emergent-learning/query/fraud_detector.py drift-alerts

# View details
python ~/.opencode/emergent-learning/scripts/baseline-refresh-scheduler.py --drift-alerts

# Acknowledge alert
python ~/.opencode/emergent-learning/scripts/baseline-refresh-scheduler.py \
