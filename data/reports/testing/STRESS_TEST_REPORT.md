...
Created: /c~/.opencode/emergent-learning/memory/failures/20251201_stress6.md
...
- `/c~/.opencode/emergent-learning/stress-test.sh`
- `/c~/.opencode/emergent-learning/precise-stress-test.sh`
- `/c~/.opencode/emergent-learning/final-stress-report.sh`
- `/c~/.opencode/emergent-learning/resource-exhaustion-test.sh`
- `/c~/.opencode/emergent-learning/test-sqlite-retry-bug.sh`
