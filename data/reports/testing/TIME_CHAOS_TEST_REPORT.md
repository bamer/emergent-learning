...
**Files Modified**:
- `C:~/.opencode/emergent-learning/scripts/record-failure.sh`
- `C:~/.opencode/emergent-learning/scripts/record-heuristic.sh`
...
### Scripts Fixed
1. **C:~/.opencode/emergent-learning/scripts/record-failure.sh**
...
2. **C:~/.opencode/emergent-learning/scripts/record-heuristic.sh**
   - Added EXECUTION_DATE variable capture
   - Fixed LOG_FILE to use EXECUTION_DATE
   - Fixed markdown date to use EXECUTION_DATE
   - Added validate_timestamp() function
...
3. **C:~/.opencode/emergent-learning/query/query.py**
...
cd ~/.opencode/emergent-learning/query
