...
/c~/.opencode/emergent-learning/memory/failures/20251201_aaaaaa[...]aaaa.md: File name too long
```
...
**File:** `/c~/.opencode/emergent-learning/scripts/record-failure.sh`
**Line:** 196-198
...
**Verification:**
```bash
ls ~/.opencode/emergent-learning/ | grep passwd  # (empty)
ls ~/.opencode/ | grep passwd                     # (empty)
```
...
- File: `/c~/.opencode/emergent-learning/scripts/record-heuristic.sh`
