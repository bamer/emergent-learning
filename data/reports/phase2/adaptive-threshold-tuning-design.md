...
**File:** `~/.opencode/emergent-learning/query/threshold_tuner.py`
...
```bash
# Run full analysis
python ~/.opencode/emergent-learning/query/threshold_tuner.py full-analysis --target-fpr 0.05
...
python ~/.opencode/emergent-learning/query/threshold_tuner.py pending
...
python ~/.opencode/emergent-learning/query/threshold_tuner.py apply --rec-id 123
...
python ~/.opencode/emergent-learning/query/threshold_tuner.py rollback --history-id 45
