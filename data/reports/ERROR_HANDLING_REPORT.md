...
### New Files Created
- `~/.opencode\emergent-learning\scripts\lib\error-handling.sh` (600+ lines)

### Modified Files
- `~/.opencode\emergent-learning\scripts\record-failure.sh` (318 lines)
- `~/.opencode\emergent-learning\scripts\record-heuristic.sh` (342 lines)
- `~/.opencode\emergent-learning\scripts\sync-db-markdown.sh` (557 lines)
- `~/.opencode\emergent-learning\scripts\start-experiment.sh` (340 lines)
