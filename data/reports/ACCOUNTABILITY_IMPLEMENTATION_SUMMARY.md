...
```bash
# Check table exists
sqlite3 ~/.opencode/emergent-learning/memory/index.db ".schema violations"

# Record test violation
bash ~/.opencode/emergent-learning/scripts/record-violation.sh 1 "Test violation"

# View banner
python ~/.opencode/emergent-learning/query/query.py --accountability-banner

# View statistics
python ~/.opencode/emergent-learning/query/query.py --stats

# Run test suite
bash ~/.opencode/emergent-learning/test-accountability.sh
