...
```bash
python3 ~/.opencode/emergent-learning/scripts/apply_10_10_robustness.py
```
...
### Manual VACUUM
```bash
sqlite3 ~/.opencode/emergent-learning/memory/index.db "VACUUM; ANALYZE"
```
...
### Restore from backup
```bash
cd ~/.opencode/emergent-learning/memory
