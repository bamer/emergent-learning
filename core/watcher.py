    ...
    def create_escalation(self, analysis: Dict[str, Any], metrics: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            with open(escalation_file, "w") as f:
                ...
                f.write(f"**Severity:** {'Critical' if analysis.get('status') == 'critical' else 'Warning'}\n\n")
                ...
                f.write("---\n\n")
                f.write("This escalation was automatically generated by the Watcher agent (Level 1).\n")
