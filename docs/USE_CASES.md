...
**Scenario:** You're building a SaaS application over 6 months. You use Opencode for features, bug fixes, and refactoring.
...
- Day 2: Opencode follows all team patterns automatically
