...
```bash
# Record a failure
~/.opencode/emergent-learning/scripts/record-failure.sh
...
```bash
# List workflow runs
python ~/.opencode/emergent-learning/conductor/query_conductor.py --workflows

# Show specific run
python ~/.opencode/emergent-learning/conductor/query_conductor.py --workflow 123

# Show failures
python ~/.opencode/emergent-learning/conductor/query_conductor.py --failures

# Show hotspots
python ~/.opencode/emergent-learning/conductor/query_conductor.py --hotspots

# Show trails by scent
python ~/.opencode/emergent-learning/conductor/query_conductor.py --trails --scent blocker

# Statistics
python ~/.opencode/emergent-learning/conductor/query_conductor.py --stats
```
